...
- Card generator: https://gh.crafter.run/topuBhuyan?theme=dark|light&bg=keep returns an SVG.

Steps:
1. Clone github.com/topuBhuyan/topuBhuyan and download both themes into its root:
   curl -fL "https://gh.crafter.run/topuBhuyan?theme=dark&cols=140&bg=keep" -o dark_mode.svg
   curl -fL "https://gh.crafter.run/topuBhuyan?theme=light&cols=140&bg=keep" -o light_mode.svg
